...
class WorldWindow < Gosu::Window
  def initialize
    ...
    @player = Entity.create(name: 'Dirge', level: 1, xp: 0, health: 100,  location_x: 1, str: 30, location_y: 1, pc?: true, image_path: 'media/fox.png', alive?: true, entity_drawn?: false)
